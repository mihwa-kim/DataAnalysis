...
# #### I suggest using Gradient Boosted Trees for predicting the Status of Future Projects. 
# #### With this ML process, each organisations could predict the planned project's results.
